/** Platform logos, copied from doppler-web's components/glyph/platform-icons.tsx. */

export type PlatformIcon = 'apple' | 'googlePlay' | 'windows';
...
export function PlatformLogo({ icon, className = 'w-8 h-8' }: { icon: PlatformIcon; className?: string }) {
  return (
